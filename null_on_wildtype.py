...
init_pop = generate_pop([(1150, base2), (30, base1), (10, base2), (10, base1), (30, base1), (10, base2), (10, base1), (30, base1), (10, base2), (10, base1), (30, base1), (10, base2), (10, base1), (1150, base2)])
...
def run():
    ...
    for i in range(200):
        ...
        if i%5 == 0:
            print i
            draw_hex_grid("pics/null_wildtype%04d.png"%i, x.pop, grid, color_fun)
